...
@Component({
  tag: "site-page-policy",
  styleUrl: "site-page-policy.scss",
  shadow: true,
})
export class SitePagePolicy {
  render() {
        ...
        <div class="main-container mf-site-container">
          <div class="policy-container">
            <div class="privacy">
              ...
              <p>Your privacy is important to us. It is Zenify SRL&#39;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://zendare.app/">https://zendare.app/</a>, and other sites we own and operate.</p>
              <p>This policy is effective as of 7 January 2022 and was last updated on 7 January 2022. </p>
